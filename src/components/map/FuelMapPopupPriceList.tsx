        ...
        <div class="flex flex-col gap-2 w-full animate-pulse">
          <div class="flex items-center justify-between p-2 rounded-lg bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-white/5">
            <div class="flex items-center gap-1.5">
              <div class="h-4 w-8 bg-slate-200 dark:bg-slate-800 rounded" />
              <div class="h-1.5 w-1.5 rounded-full bg-slate-400 dark:bg-slate-600" />
            </div>
            <div class="h-5 w-24 bg-slate-200 dark:bg-slate-800 rounded" />
          </div>
          <div class="flex items-center justify-between p-2 rounded-lg bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-white/5">
            <div class="flex items-center gap-1.5">
              <div class="h-4 w-8 bg-slate-200 dark:bg-slate-800 rounded" />
