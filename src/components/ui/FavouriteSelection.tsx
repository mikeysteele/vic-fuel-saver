...
export function FavourableIcon(props: { class?: string }) {
    ...
    return (
        <button
            ...
            class={`p-2 rounded-xl transition-all duration-300 flex items-center justify-center shrink-0 ${context.isFavourited()
            ...
            title={context.isFavourited() ? "Remove from favourites" : "Add to favourites"}
        >
            <svg
...
export function withFavouratable<P extends FavouratableComponentProps>(
    ...
    return (props) => {
        const storageKey = () => props.storageKey || props.id || "unnamed_favourite";
        ...
        return (
            ...
            >
                <div class={`flex items-center gap-2 w-full group/favourable ${props.wrapperClass || ""}`}>
                    <div class="flex-1">
