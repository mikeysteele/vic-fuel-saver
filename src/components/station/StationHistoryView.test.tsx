...
describe("StationHistoryView", () => {
  it("renders loading state", () => {
    vi.mocked(getStationPriceHistory).mockImplementation(() =>
      new Promise(() => {})
    );
  ...
  it("renders error state", async () => {
    ...
    expect(await screen.findByText("Failed to load history."))
      .toBeInTheDocument();
  });
  ...
  it("renders empty state", async () => {
    ...
    expect(await findByText("No history available for this station yet."))
      .toBeInTheDocument();
  });
    ...
    vi.mocked(getStationPriceHistory).mockResolvedValue([
      {
        fuelType: "U91",
        price: 150.5,
        updatedAt: "1970-01-01T12:00:00Z",
        stationId: "123",
        isAvailable: true,
        priceDate: "1970-01-01",
        syncedAt: "1970-01-01V12:00:00Z",
      },
      {
        fuelType: "U91",
        price: 151.5,
