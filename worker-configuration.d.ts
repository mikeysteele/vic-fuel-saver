/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d1df61a3ea5100ff83f2a06b1acfdae)
...
type StringifyValues<EnvType extends Record<string, unknown>> = {
  [Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding]
    : string;
};
declare namespace NodeJS {
  interface ProcessEnv extends
    StringifyValues<
      Pick<
        Cloudflare.Env,
        "VIC_FUEL_CONSUMER_ID" | "LOGO_DEV_SECRET_KEY" | "VITE_LOGO_DEV_TOKEN"
      >
    > {}
}
